...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { category_id: @letter.category_id, received_time: @letter.received_time, user_id: @letter.user_id }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { category_id: @letter.category_id, received_time: @letter.received_time, user_id: @letter.user_id }
    assert_redirected_to letter_path(assigns(:letter))
  end
